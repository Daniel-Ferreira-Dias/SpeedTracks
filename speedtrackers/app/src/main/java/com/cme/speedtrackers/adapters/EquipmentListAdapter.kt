...
class EquipmentListAdapter(private var equipmentList: ArrayList<UserEquipment>) : RecyclerView.Adapter<EquipmentListAdapter.CustomViewHolder>() {
    ...
    public fun setFilteredList(filteredList: ArrayList<UserEquipment>) {
    ...
    override fun onBindViewHolder(holder: EquipmentListAdapter.CustomViewHolder, position: Int) {
        ...
        // set Item to Value
        setModeloNameAndImage(currentView.ModeloID, currentView.MarcaID, holder, currentView)
        ...
        dbRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()) {
                    ...
                    dbRef.child("Equipments").child(currentItem.ID.toString()).child("modeloNome")
                        .setValue(model?.Nome_Modelo.toString())
